    ...
    <div>
      <h3 className='text-xl font-semibold mb-4'> Your Orders</h3>
      {
        ordersData.map((order)=>(
            <>
            <div key={order.id} className='bg-white p-5 rounded-md mb-2 overflow-hidden'>
                <div className='flex items-start gap-10'>
                    ...
                    <div className='flex items-start justify-between w-full'>
                        <div className='flex-1'>
                            ...
                            <p className='text-sm font-semibold text-gray-700 mt-2'>{order.datetime} - {order.cinema}</p>
                            <small className='text-gray-700 mt-1'>Quantity: {order.quantity}</small>
